...
QUESTION_CATALOG = (
    ...
    QuestionDefinition("security", "Segurança", "Encontre possíveis riscos de segurança em src/. Diferencie achados confirmados de riscos potenciais e mencione controles observados.", "Riscos encontrados e controles existentes", ("semantic_search", "read_file", "analyze_vulnerabilities"), (("static_analysis", ("analyze_vulnerabilities",)),), _STANDARD + ("security_findings_have_evidence",), ("severity_proportionality", "groundedness")),
